...
@kgossent/sfdx-md-merge-driver/1.0.0-alpha.10 win32-x64 node-v22.13.1
...
FLAGS
  -d, --driver=<value>     [default: npx --legacy-peer-deps @kgossent/sfdx-md-merge-driver merge -o %O -a %A -b %B -p
                           %P] string to install as the driver in the git configuration
...
_See code: [src/commands/install.ts](https://github.com/KevinGossentCap/sfdc_merge/blob/v1.0.0-alpha.10/src/commands/install.ts)_
...
_See code: [src/commands/merge.ts](https://github.com/KevinGossentCap/sfdc_merge/blob/v1.0.0-alpha.10/src/commands/merge.ts)_
...
_See code: [src/commands/uninstall.ts](https://github.com/KevinGossentCap/sfdc_merge/blob/v1.0.0-alpha.10/src/commands/uninstall.ts)_
<!-- commandsstop -->
